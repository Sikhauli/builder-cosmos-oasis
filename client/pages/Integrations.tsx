...
const defaultMap: Mapping[] = [
  {
    code: "Regular",
    debit: "6000 Payroll Expense",
    credit: "2100 Wages Payable",
  },
  {
    code: "Overtime",
    debit: "6001 Overtime Expense",
    credit: "2100 Wages Payable",
  },
...
function mask(t: string, show: boolean) {
  return show ? t : t.replace(/.(?=.{4})/g, "•");
}
...
export default function Integrations() {
  ...
  const [tokens, setTokens] = useState<
    { id: string; value: string; created: string }[]
  >([
    {
  ...
  function addRow() {
    setMapping((p) => [...p, { code: "Custom", debit: "", credit: "" }]);
  }
  ...
  function regenerateToken() {
    ...
    toast({
      title: "Token created",
      description: "Copy and store it securely.",
    });
  }
  ...
  return (
    <div className="container mx-auto py-4">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-xs text-muted-foreground">
            Integrate GL with QuickBooks/Xero/Sage, sync HRIS/ATS, bulk CSV/XLSX
            import/export, and manage REST API tokens and webhook subscriptions
            with event previews.
          </p>
        </div>
        <div className="flex items-center gap-2">
          <Button
            ...
            onClick={() =>
              toast({
                title: "CSV exported",
                description: "GL and runs exported.",
              })
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              toast({
                title: "Imported",
                description: "Bulk edit file processed.",
              })
            }
          >
      ...
      <div className="grid gap-3 lg:grid-cols-3">
        <section className="rounded-md border p-3 lg:col-span-2">
          <header className="mb-2 inline-flex items-center gap-2 text-xs font-medium">
            <GitCompare className="h-3.5 w-3.5" /> GL mapping
          </header>
          <div className="mb-2 flex items-center gap-2 text-[11px]">
            ...
            >
              {(["QuickBooks", "Xero", "Sage"] as Provider[]).map((p) => (
          ...
          <div className="overflow-hidden rounded border">
            ...
            <div className="flex items-center justify-between border-t px-3 py-2 text-[11px]">
              <div className="text-muted-foreground">
                Map earnings/deductions/benefits to accounts.
              </div>
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                ...
                <Button
                  ...
                  onClick={() =>
                    toast({
                      title: "Saved",
                      description: "GL mapping updated.",
                    })
                  }
                >
        ...
        <section className="rounded-md border p-3">
          <header className="mb-2 inline-flex items-center gap-2 text-xs font-medium">
            <Database className="h-3.5 w-3.5" /> HRIS / ATS
          </header>
          <ul className="space-y-2 text-[11px]">
            <li className="rounded border p-2">
              Sync employees and reconcile new hires from HRIS.
            </li>
            <li className="rounded border p-2">
              ATS offers candidate → employee conversion.
            </li>
            <li className="rounded border p-2">
              Schedule daily pull or manual sync.
            </li>
          </ul>
          <Button
            variant="outline"
            ...
            onClick={() =>
              toast({ title: "Synced", description: "HRIS data pulled." })
            }
          >
            Sync now
          </Button>
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-3">
        <section className="rounded-md border p-3">
          <header className="mb-2 inline-flex items-center gap-2 text-xs font-medium">
            <Key className="h-3.5 w-3.5" /> API tokens
          </header>
          ...
          <div className="grid gap-2 md:grid-cols-2">
            <div className="rounded border p-3 text-[11px]">
              ...
              <Button
                ...
                onClick={() =>
                  toast({
                    title: "Subscribed",
                    description: `Webhook set to ${endpoint}`,
                  })
                }
              >
                Save subscription
            ...
            <div className="rounded border p-3 text-[11px]">
              <div className="mb-1 inline-flex items-center gap-1 font-medium">
                <BookOpenCheck className="h-3.5 w-3.5" /> Event preview
              </div>
              <pre className="h-40 overflow-auto rounded bg-secondary/50 p-2 text-[10px]">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <Button
                  className="h-7 px-2 text-xs"
                  onClick={() =>
                    navigator.clipboard.writeText(JSON.stringify(preview))
                  }
                >
                  Copy payload
                </Button>
